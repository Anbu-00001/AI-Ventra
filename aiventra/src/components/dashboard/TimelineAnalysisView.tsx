...
// No fallback data — views populate only from backend analysis of uploaded evidence
        ...
        <div className="relative z-10 flex-1 flex items-center px-12 overflow-x-auto scrollbar-hide py-16">
          {events.length === 0 ? (
            <div className="w-full flex justify-center">
              <EmptyState message="No timeline events reconstructed. Upload GPS, CCTV, or Case logs to generate a timeline." />
            </div>
          ) : (
            ...
            <div className="w-24 h-16 bg-black rounded border border-white/10 overflow-hidden flex items-center justify-center">
              {selectedEvent?.type?.includes("CCTV") ? (
                <div className="relative w-full h-full">
                  ...
                  <Image src="/api/placeholder/96/64" alt="CCTV" width={96} height={64} className="w-full h-full object-cover opacity-50" />
                </div>
              ) : (
